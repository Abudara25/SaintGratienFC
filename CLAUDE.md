...
- SEO rationale for future news articles: each published article is meant to become its own indexable page (a real detail page, not just a lightbox teaser) — more pages on the site means more entry points Google can index, which is the point of eventually building out real articles instead of just teaser cards.
