...
<header class="site-header">
  <div class="container">
    ...
    <nav class="main-nav" id="main-nav" aria-label="Navigation principale">
      ...
      <a href="/inscription.html" class="btn btn-primary btn-sm nav-cta adhesion-cta">Devenir adhérent</a>
    </nav>
    <div class="header-actions">
      <a href="/inscription.html" class="btn btn-primary btn-sm adhesion-cta">Devenir adhérent</a>
